...
<head>
    ...
    <title>
        ...
        // Запрос к базе данных для получения данных о выбранной машине
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                // Динамическое формирование заголовка
...
.article__description {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row["document"] == 1 || $row["repair"] == 1) {
            ...
            echo "<a href='tel: +74951234567' class='link__number'><span class='link__number-text'>Позвонить продавцу</span>
            <span class='link__number-telephone'>+• ••• ••• •• ••</span></a>";
            echo "</div>";
            echo "</div>";
